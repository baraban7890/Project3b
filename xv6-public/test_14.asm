...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 0f 05 00 00       	call   526 <getpid>
  ...
  b7:	e8 1a 04 00 00       	call   4d6 <kill>
  bc:	e8 e5 03 00 00       	call   4a6 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  e7:	e8 24 05 00 00       	call   610 <printf>
   exit();
  ec:	e8 b5 03 00 00       	call   4a6 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 169:	e8 68 03 00 00       	call   4d6 <kill>
 16e:	e8 33 03 00 00       	call   4a6 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 ...
 2d9:	31 db                	xor    %ebx,%ebx
{
 ...
 2e5:	57                   	push   %edi
 2e6:	6a 00                	push   $0x0
 2e8:	e8 d1 01 00 00       	call   4be <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
 ...
 34d:	e8 94 01 00 00       	call   4e6 <open>
  if (fd < 0)
 ...
 361:	50                   	push   %eax
 362:	e8 97 01 00 00       	call   4fe <fstat>
  close(fd);
 367:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 36a:	89 c6                	mov    %eax,%esi
  close(fd);
 36c:	e8 5d 01 00 00       	call   4ce <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 40b:	e8 30 04 00 00       	call   840 <malloc>
 ...
 41a:	e8 27 01 00 00       	call   546 <clone>
...
int thread_join()
{
 ...
 433:	53                   	push   %ebx
 434:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 437:	6a 04                	push   $0x4
 439:	e8 02 04 00 00       	call   840 <malloc>
 43e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 441:	8d 45 f4             	lea    -0xc(%ebp),%eax
 444:	89 04 24             	mov    %eax,(%esp)
 447:	e8 02 01 00 00       	call   54e <join>
 44c:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 44e:	58                   	pop    %eax
 44f:	ff 75 f4             	push   -0xc(%ebp)
 452:	e8 59 03 00 00       	call   7b0 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 463:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 466:	83 38 01             	cmpl   $0x1,(%eax)
 469:	75 05                	jne    470 <lock_acquire+0x10>
 46b:	eb fe                	jmp    46b <lock_acquire+0xb>
 46d:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 470:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 476:	5d                   	pop    %ebp
 477:	c3                   	ret    
...
free(void *ap)
{
 ...
 7b1:	a1 a8 0d 00 00       	mov    0xda8,%eax
{
 ...
 7f1:	5b                   	pop    %ebx
  freep = p;
 7f2:	89 15 a8 0d 00 00    	mov    %edx,0xda8
}
 7f8:	5e                   	pop    %esi
 7f9:	5f                   	pop    %edi
 7fa:	5d                   	pop    %ebp
 ...
 829:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 82c:	89 15 a8 0d 00 00    	mov    %edx,0xda8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 849:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 84c:	8b 3d a8 0d 00 00    	mov    0xda8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 88f:	73 4f                	jae    8e0 <malloc+0xa0>
    ...
    if(p == freep)
 891:	8b 3d a8 0d 00 00    	mov    0xda8,%edi
 ...
 8ba:	e8 f1 fe ff ff       	call   7b0 <free>
  return freep;
 8bf:	8b 15 a8 0d 00 00    	mov    0xda8,%edx
 ...
 8ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ef:	89 15 a8 0d 00 00    	mov    %edx,0xda8
}
 ...
 8ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 900:	c7 05 a8 0d 00 00 ac 	movl   $0xdac,0xda8
 907:	0d 00 00 
    base.s.size = 0;
 90a:	bf ac 0d 00 00       	mov    $0xdac,%edi
    base.s.ptr = freep = prevp = &base;
 90f:	c7 05 ac 0d 00 00 ac 	movl   $0xdac,0xdac
 916:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 919:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 91b:	c7 05 b0 0d 00 00 00 	movl   $0x0,0xdb0
 922:	00 00 00 
    if(p->s.size >= nunits){
