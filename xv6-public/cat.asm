...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 37a:	e8 27 01 00 00       	call   4a6 <clone>
...
int thread_join()
{
 ...
 393:	53                   	push   %ebx
 394:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 397:	6a 04                	push   $0x4
 399:	e8 02 04 00 00       	call   7a0 <malloc>
 39e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 3a1:	8d 45 f4             	lea    -0xc(%ebp),%eax
 3a4:	89 04 24             	mov    %eax,(%esp)
 3a7:	e8 02 01 00 00       	call   4ae <join>
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba d0 08 00 00       	mov    $0x8d0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 c0 0e 00 00       	mov    0xec0,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 c0 0e 00 00    	mov    %edx,0xec0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 867:	0e 00 00 
    base.s.size = 0;
 86a:	bf c4 0e 00 00       	mov    $0xec4,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 876:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 882:	00 00 00 
    if(p->s.size >= nunits){
