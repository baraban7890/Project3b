   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 09 05 00 00       	call   526 <getpid>
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 bd 04 00 00       	call   52e <sbrk>
  ...
  8d:	e8 7e 05 00 00       	call   610 <printf>
   exit();
  92:	e8 0f 04 00 00       	call   4a6 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  ...
  d3:	e8 fe 03 00 00       	call   4d6 <kill>
  d8:	e8 c9 03 00 00       	call   4a6 <exit>
  dd:	6a 22                	push   $0x22
...
worker(void *arg1, void *arg2) {
 ...
 18c:	e8 45 03 00 00       	call   4d6 <kill>
 191:	e8 10 03 00 00       	call   4a6 <exit>
   global += 4;
 196:	a1 c4 0d 00 00       	mov    0xdc4,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 c4 0d 00 00       	mov    %eax,0xdc4
   exit();
 1a3:	e8 fe 02 00 00       	call   4a6 <exit>
