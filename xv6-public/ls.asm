...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 5aa:	e8 27 01 00 00       	call   6d6 <clone>
...
int thread_join()
{
 ...
 5c3:	53                   	push   %ebx
 5c4:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 5c7:	6a 04                	push   $0x4
 5c9:	e8 02 04 00 00       	call   9d0 <malloc>
 5ce:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 5d1:	8d 45 f4             	lea    -0xc(%ebp),%eax
 5d4:	89 04 24             	mov    %eax,(%esp)
 5d7:	e8 02 01 00 00       	call   6de <join>
 5dc:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 5de:	58                   	pop    %eax
 5df:	ff 75 f4             	push   -0xc(%ebp)
 5e2:	e8 59 03 00 00       	call   940 <free>
  lock_release(&lock);
 ...
 6fc:	89 d1                	mov    %edx,%ecx
{
 ...
 729:	0f b6 92 74 0b 00 00 	movzbl 0xb74(%edx),%edx
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 819:	ff 24 85 1c 0b 00 00 	jmp    *0xb1c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 927:	90                   	nop
          s = "(null)";
 928:	ba 12 0b 00 00       	mov    $0xb12,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 941:	a1 58 0f 00 00       	mov    0xf58,%eax
{
 ...
 981:	5b                   	pop    %ebx
  freep = p;
 982:	89 15 58 0f 00 00    	mov    %edx,0xf58
}
 988:	5e                   	pop    %esi
 989:	5f                   	pop    %edi
 98a:	5d                   	pop    %ebp
 ...
 9b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9bc:	89 15 58 0f 00 00    	mov    %edx,0xf58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 3d 58 0f 00 00    	mov    0xf58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a1f:	73 4f                	jae    a70 <malloc+0xa0>
    ...
    if(p == freep)
 a21:	8b 3d 58 0f 00 00    	mov    0xf58,%edi
 ...
 a4a:	e8 f1 fe ff ff       	call   940 <free>
  return freep;
 a4f:	8b 15 58 0f 00 00    	mov    0xf58,%edx
 ...
 a97:	0f 00 00 
    base.s.size = 0;
 a9a:	bf 5c 0f 00 00       	mov    $0xf5c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 aa9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 aab:	c7 05 60 0f 00 00 00 	movl   $0x0,0xf60
 ab2:	00 00 00 
    if(p->s.size >= nunits){
