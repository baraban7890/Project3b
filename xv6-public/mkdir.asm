...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 2ea:	e8 27 01 00 00       	call   416 <clone>
...
int thread_join()
{
 ...
 303:	53                   	push   %ebx
 304:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 307:	6a 04                	push   $0x4
 309:	e8 02 04 00 00       	call   710 <malloc>
 30e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 311:	8d 45 f4             	lea    -0xc(%ebp),%eax
 314:	89 04 24             	mov    %eax,(%esp)
 317:	e8 02 01 00 00       	call   41e <join>
...
void lock_acquire(lock_t *lock)
{
 ...
 333:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 336:	83 38 01             	cmpl   $0x1,(%eax)
 339:	75 05                	jne    340 <lock_acquire+0x10>
 33b:	eb fe                	jmp    33b <lock_acquire+0xb>
 33d:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 340:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 346:	5d                   	pop    %ebp
 347:	c3                   	ret    
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 3b 08 00 00       	mov    $0x83b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 f8 0b 00 00       	mov    0xbf8,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 f8 0b 00 00    	mov    %edx,0xbf8
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 f8 0b 00 00    	mov    %edx,0xbf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d f8 0b 00 00    	mov    0xbf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d f8 0b 00 00    	mov    0xbf8,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 f8 0b 00 00    	mov    0xbf8,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 f8 0b 00 00    	mov    %edx,0xbf8
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 f8 0b 00 00 fc 	movl   $0xbfc,0xbf8
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf fc 0b 00 00       	mov    $0xbfc,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 fc 0b 00 00 fc 	movl   $0xbfc,0xbfc
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 00 0c 00 00 00 	movl   $0x0,0xc00
 7f2:	00 00 00 
    if(p->s.size >= nunits){
