...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 a2 05 00 00       	call   5b6 <getpid>
  ...
  a0:	e8 c1 04 00 00       	call   566 <kill>
  a5:	e8 8c 04 00 00       	call   536 <exit>
   for (i = 0; i < num_threads; i++) {
 ...
 11d:	e8 7e 05 00 00       	call   6a0 <printf>
   exit();
 122:	e8 0f 04 00 00       	call   536 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 14e:	e8 bd 03 00 00       	call   510 <lock_release>
    exit();
 153:	e8 de 03 00 00       	call   536 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1eb:	e8 76 03 00 00       	call   566 <kill>
 1f0:	e8 41 03 00 00       	call   536 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
...
free(void *ap)
{
 ...
 841:	a1 6c 0e 00 00       	mov    0xe6c,%eax
{
 ...
 881:	5b                   	pop    %ebx
  freep = p;
 882:	89 15 6c 0e 00 00    	mov    %edx,0xe6c
}
 888:	5e                   	pop    %esi
 889:	5f                   	pop    %edi
 88a:	5d                   	pop    %ebp
 ...
 8b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8bc:	89 15 6c 0e 00 00    	mov    %edx,0xe6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8dc:	8b 3d 6c 0e 00 00    	mov    0xe6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 91f:	73 4f                	jae    970 <malloc+0xa0>
    ...
    if(p == freep)
 921:	8b 3d 6c 0e 00 00    	mov    0xe6c,%edi
 ...
 94a:	e8 f1 fe ff ff       	call   840 <free>
  return freep;
 94f:	8b 15 6c 0e 00 00    	mov    0xe6c,%edx
 ...
 97c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 97f:	89 15 6c 0e 00 00    	mov    %edx,0xe6c
}
 ...
 98f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 990:	c7 05 6c 0e 00 00 70 	movl   $0xe70,0xe6c
 997:	0e 00 00 
    base.s.size = 0;
 99a:	bf 70 0e 00 00       	mov    $0xe70,%edi
    base.s.ptr = freep = prevp = &base;
 99f:	c7 05 70 0e 00 00 70 	movl   $0xe70,0xe70
 9a6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9ab:	c7 05 74 0e 00 00 00 	movl   $0x0,0xe74
 9b2:	00 00 00 
    if(p->s.size >= nunits){
