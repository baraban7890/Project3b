...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 35a:	e8 27 01 00 00       	call   486 <clone>
...
int thread_join()
{
 ...
 38c:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 38e:	58                   	pop    %eax
 38f:	ff 75 f4             	push   -0xc(%ebp)
 392:	e8 59 03 00 00       	call   6f0 <free>
  lock_release(&lock);
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 d0 08 00 00 	jmp    *0x8d0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba c8 08 00 00       	mov    $0x8c8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 80 0c 00 00       	mov    0xc80,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 80 0c 00 00    	mov    %edx,0xc80
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 80 0c 00 00    	mov    %edx,0xc80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d 80 0c 00 00    	mov    0xc80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d 80 0c 00 00    	mov    0xc80,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 80 0c 00 00    	mov    0xc80,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 80 0c 00 00    	mov    %edx,0xc80
}
