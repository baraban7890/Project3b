...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 ff 59 10 80 	movl   $0x801059ff,0x14(%eax)
  p->context = (struct context*)sp;
...
80103c80:	e8 0b 2f 00 00       	call   80106b90 <switchuvm>
...
80103c92:	e8 d4 0c 00 00       	call   8010496b <swtch>
      switchkvm();
80103c97:	e8 e4 2e 00 00       	call   80106b80 <switchkvm>
      c->proc = 0;
...
80103f89:	e8 e2 2f 00 00       	call   80106f70 <freevm>
        p->pid = 0;
...
801041fb:	68 9f 7c 10 80       	push   $0x80107c9f
...
801042a6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801042a9:	e8 92 02 00 00       	call   80104540 <pushcli>
  c = mycpu();
801042ae:	e8 3d f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801042b3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042b9:	e8 d2 02 00 00       	call   80104590 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
801042d0:	8b 43 04             	mov    0x4(%ebx),%eax
  np->ustack = stack;
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
801042d3:	8b 79 18             	mov    0x18(%ecx),%edi
  np->pgdir = curproc->pgdir;
801042d6:	89 41 04             	mov    %eax,0x4(%ecx)
  np->ustack = stack;
801042d9:	8b 45 14             	mov    0x14(%ebp),%eax
801042dc:	89 41 7c             	mov    %eax,0x7c(%ecx)
  np->sz = curproc->sz;
801042df:	8b 03                	mov    (%ebx),%eax
  np->parent = curproc;
801042e1:	89 59 14             	mov    %ebx,0x14(%ecx)
  np->sz = curproc->sz;
801042e4:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
801042e6:	89 c8                	mov    %ecx,%eax
  *np->tf = *curproc->tf;
801042e8:	8b 73 18             	mov    0x18(%ebx),%esi
801042eb:	b9 13 00 00 00       	mov    $0x13,%ecx
801042f0:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0xffffffff;

  for(i = 0; i < NOFILE; i++)
801042f2:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0xffffffff;
801042f4:	8b 40 18             	mov    0x18(%eax),%eax
801042f7:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
...
80104341:	e8 ca 05 00 00       	call   80104910 <safestrcpy>
...
80104350:	e8 3b 03 00 00       	call   80104690 <acquire>
...
80104363:	e8 c8 02 00 00       	call   80104630 <release>
...
8010439a:	68 a4 79 10 80       	push   $0x801079a4
...
801045d5:	68 af 79 10 80       	push   $0x801079af
801045da:	e8 a1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045df:	83 ec 0c             	sub    $0xc,%esp
801045e2:	68 c6 79 10 80       	push   $0x801079c6
...
8010464b:	68 cd 79 10 80       	push   $0x801079cd
...
80104740:	68 d5 79 10 80       	push   $0x801079d5
...
80104b6c:	8b 14 85 00 7a 10 80 	mov    -0x7fef8600(,%eax,4),%edx
...
80104b98:	68 dd 79 10 80       	push   $0x801079dd
...
80104cf4:	68 7c 7a 10 80       	push   $0x80107a7c
...
80104d0c:	68 7b 7a 10 80       	push   $0x80107a7b
...
80104d21:	68 6f 7a 10 80       	push   $0x80107a6f
...
80104d3f:	68 7e 7a 10 80       	push   $0x80107a7e
80104d44:	e8 37 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d49:	83 ec 0c             	sub    $0xc,%esp
80104d4c:	68 60 7a 10 80       	push   $0x80107a60
...
8010514d:	58                   	pop    %eax
8010514e:	5a                   	pop    %edx
8010514f:	68 7c 7a 10 80       	push   $0x80107a7c
...
80105168:	68 7b 7a 10 80       	push   $0x80107a7b
...
8010587a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010587d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while (ticks - ticks0 < n)
...
80105898:	68 60 3d 11 80       	push   $0x80113d60
8010589d:	e8 9e e7 ff ff       	call   80104040 <sleep>
  while (ticks - ticks0 < n)
801058a2:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
801058c0:	68 80 3d 11 80       	push   $0x80113d80
...
801058e3:	68 80 3d 11 80       	push   $0x80113d80
...
80105904:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105907:	68 80 3d 11 80       	push   $0x80113d80
8010590c:	e8 7f ed ff ff       	call   80104690 <acquire>
  xticks = ticks;
80105911:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105917:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
8010593c:	e8 cf f0 ff ff       	call   80104a10 <argint>
80105941:	83 c4 10             	add    $0x10,%esp
80105944:	85 c0                	test   %eax,%eax
80105946:	78 58                	js     801059a0 <sys_clone+0x70>
    return -1;
  }
  if (argint(1, &arg1) < 0) {
...
80105951:	e8 ba f0 ff ff       	call   80104a10 <argint>
80105956:	83 c4 10             	add    $0x10,%esp
80105959:	85 c0                	test   %eax,%eax
8010595b:	78 43                	js     801059a0 <sys_clone+0x70>
    return - 1;
  }
  if (argint(2, &arg2) < 0) {
...
80105966:	e8 a5 f0 ff ff       	call   80104a10 <argint>
8010596b:	83 c4 10             	add    $0x10,%esp
8010596e:	85 c0                	test   %eax,%eax
80105970:	78 2e                	js     801059a0 <sys_clone+0x70>
    return -1;
  }
  if (argint(3, &stack) < 0) {
...
8010597b:	e8 90 f0 ff ff       	call   80104a10 <argint>
80105980:	83 c4 10             	add    $0x10,%esp
80105983:	85 c0                	test   %eax,%eax
80105985:	78 19                	js     801059a0 <sys_clone+0x70>
    return -1;
  }
...
80105993:	e8 08 e9 ff ff       	call   801042a0 <clone>
...
801059bc:	e8 4f f0 ff ff       	call   80104a10 <argint>
801059c1:	83 c4 10             	add    $0x10,%esp
801059c4:	85 c0                	test   %eax,%eax
801059c6:	75 18                	jne    801059e0 <sys_join+0x30>
    return -1;
  }
  return join((void**)stack);
801059c8:	83 ec 0c             	sub    $0xc,%esp
801059cb:	ff 75 f4             	push   -0xc(%ebp)
801059ce:	e8 ad e9 ff ff       	call   80104380 <join>
...
80105a5e:	00 00 ef 
  initlock(&tickslock, "time");
80105a61:	68 c1 7a 10 80       	push   $0x80107ac1
...
80105a74:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105a7a:	e8 41 ea ff ff       	call   801044c0 <initlock>
}
...
80105ae4:	ff 24 85 68 7b 10 80 	jmp    *-0x7fef8498(,%eax,4)
...
80105bc5:	68 24 7b 10 80       	push   $0x80107b24
...
80105bf4:	0f 85 3e ff ff ff    	jne    80105b38 <trap+0x78>
    yield();
80105bfa:	e8 f1 e3 ff ff       	call   80103ff0 <yield>
...
80105c17:	68 cc 7a 10 80       	push   $0x80107acc
...
80105c55:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c58:	e8 f3 ee ff ff       	call   80104b50 <syscall>
    if(myproc()->killed)
...
80105c73:	5d                   	pop    %ebp
      exit();
80105c74:	e9 17 e1 ff ff       	jmp    80103d90 <exit>
...
80105d12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d18:	e8 73 e0 ff ff       	call   80103d90 <exit>
...
80105d33:	68 f0 7a 10 80       	push   $0x80107af0
80105d38:	e8 63 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d3d:	83 c4 14             	add    $0x14,%esp
80105d40:	68 c6 7a 10 80       	push   $0x80107ac6
...
80105dec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105def:	bf e8 7b 10 80       	mov    $0x80107be8,%edi
...
80106a95:	e8 b6 dc ff ff       	call   80104750 <memset>
...
80106add:	68 f0 7b 10 80       	push   $0x80107bf0
...
80106bb4:	0f 84 c2 00 00 00    	je     80106c7c <switchuvm+0xec>
  pushcli();
80106bba:	e8 81 d9 ff ff       	call   80104540 <pushcli>
...
80106d02:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d03:	e9 e8 da ff ff       	jmp    801047f0 <memmove>
    panic("inituvm: more than a page");
80106d08:	83 ec 0c             	sub    $0xc,%esp
80106d0b:	68 35 7c 10 80       	push   $0x80107c35
...
80106d70:	68 4f 7c 10 80       	push   $0x80107c4f
...
80106df8:	68 f0 7c 10 80       	push   $0x80107cf0
...
80106e5b:	e8 f0 d8 ff ff       	call   80104750 <memset>
...
80106e99:	68 6d 7c 10 80       	push   $0x80107c6d
...
80106efb:	68 85 7c 10 80       	push   $0x80107c85
...
80106fdc:	68 a1 7c 10 80       	push   $0x80107ca1
...
80107010:	e8 3b d7 ff ff       	call   80104750 <memset>
...
801070ac:	68 b2 7c 10 80       	push   $0x80107cb2
...
80107122:	68 bc 7c 10 80       	push   $0x80107cbc
...
80107180:	e8 6b d6 ff ff       	call   801047f0 <memmove>
...
801071f7:	68 d6 7c 10 80       	push   $0x80107cd6
...
801072b0:	e8 3b d5 ff ff       	call   801047f0 <memmove>
    len -= n;
    buf += n;
