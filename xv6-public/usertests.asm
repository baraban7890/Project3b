...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 8b 39 00 00       	call   39b6 <open>
    ...
    exit();
      40:	e8 31 39 00 00       	call   3976 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 60 39 00 00       	call   39b6 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 40 39 00 00       	call   399e <close>
  ...
  exit();
     10d:	e8 64 38 00 00       	call   3976 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 90 38 00 00       	call   39e6 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 58 38 00 00       	call   39c6 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 64 38 00 00       	call   39e6 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 9c 5f 00 00    	push   0x5f9c
     1ae:	e8 2d 39 00 00       	call   3ae0 <printf>
    exit();
     1b3:	e8 be 37 00 00       	call   3976 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 53 3e 00 00       	push   $0x3e53
     1bf:	ff 35 9c 5f 00 00    	push   0x5f9c
     1c5:	e8 16 39 00 00       	call   3ae0 <printf>
    exit();
     1ca:	e8 a7 37 00 00       	call   3976 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 37 3e 00 00       	push   $0x3e37
     1d6:	ff 35 9c 5f 00 00    	push   0x5f9c
     1dc:	e8 ff 38 00 00       	call   3ae0 <printf>
    exit();
     1e1:	e8 90 37 00 00       	call   3976 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 16 3e 00 00       	push   $0x3e16
     1ed:	ff 35 9c 5f 00 00    	push   0x5f9c
     1f3:	e8 e8 38 00 00       	call   3ae0 <printf>
    exit();
     1f8:	e8 79 37 00 00       	call   3976 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 9c 5f 00 00    	push   0x5f9c
     211:	e8 ca 38 00 00       	call   3ae0 <printf>
  pid = fork();
     216:	e8 53 37 00 00       	call   396e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 a9 37 00 00       	call   39de <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 99 37 00 00       	call   39e6 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 61 37 00 00       	call   39c6 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 05 37 00 00       	call   3976 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 01 37 00 00       	call   397e <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 86 3e 00 00       	push   $0x3e86
     285:	ff 35 9c 5f 00 00    	push   0x5f9c
     ...
     2a0:	ff 35 9c 5f 00 00    	push   0x5f9c
     2a6:	e8 35 38 00 00       	call   3ae0 <printf>
      exit();
     2ab:	e8 c6 36 00 00       	call   3976 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 49 4d 00 00       	push   $0x4d49
     2b7:	ff 35 9c 5f 00 00    	push   0x5f9c
     2bd:	e8 1e 38 00 00       	call   3ae0 <printf>
    exit();
     2c2:	e8 af 36 00 00       	call   3976 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 08 3e 00 00       	push   $0x3e08
     2ce:	ff 35 9c 5f 00 00    	push   0x5f9c
     2d4:	e8 07 38 00 00       	call   3ae0 <printf>
      exit();
     2d9:	e8 98 36 00 00       	call   3976 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 72 3e 00 00       	push   $0x3e72
     2e5:	ff 35 9c 5f 00 00    	push   0x5f9c
     2eb:	e8 f0 37 00 00       	call   3ae0 <printf>
      exit();
     2f0:	e8 81 36 00 00       	call   3976 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 6f 36 00 00       	call   39b6 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 c1 35 00 00       	call   3976 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 49 4d 00 00       	push   $0x4d49
     3bc:	ff 35 9c 5f 00 00    	push   0x5f9c
     3c2:	e8 19 37 00 00       	call   3ae0 <printf>
    exit();
     3c7:	e8 aa 35 00 00       	call   3976 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 ad 3e 00 00       	push   $0x3ead
     3d3:	ff 35 9c 5f 00 00    	push   0x5f9c
     3d9:	e8 02 37 00 00       	call   3ae0 <printf>
    exit();
     3de:	e8 93 35 00 00       	call   3976 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 c1 3e 00 00       	push   $0x3ec1
     3ea:	ff 35 9c 5f 00 00    	push   0x5f9c
     3f0:	e8 eb 36 00 00       	call   3ae0 <printf>
    exit();
     3f5:	e8 7c 35 00 00       	call   3976 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 92 35 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 6a 35 00 00       	call   399e <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 05 3f 00 00       	push   $0x3f05
     43d:	e8 74 35 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 9c 5f 00 00    	push   0x5f9c
     46e:	e8 6d 36 00 00       	call   3ae0 <printf>
    exit();
     473:	e8 fe 34 00 00       	call   3976 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 12 3f 00 00       	push   $0x3f12
     47f:	ff 35 9c 5f 00 00    	push   0x5f9c
     485:	e8 56 36 00 00       	call   3ae0 <printf>
    exit();
     48a:	e8 e7 34 00 00       	call   3976 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 fd 34 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 a6 34 00 00       	call   3996 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 8a 34 00 00       	call   3996 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 9c 5f 00 00    	push   0x5f9c
     52e:	e8 ad 35 00 00       	call   3ae0 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 63 34 00 00       	call   399e <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 4f 3f 00 00       	push   $0x3f4f
     544:	e8 6d 34 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 12 34 00 00       	call   398e <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 9c 5f 00 00    	push   0x5f9c
     598:	e8 43 35 00 00       	call   3ae0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 f9 33 00 00       	call   399e <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 4f 3f 00 00 	movl   $0x3f4f,(%esp)
     5ac:	e8 15 34 00 00       	call   39c6 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 9c 5f 00 00    	push   0x5f9c
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 1d 33 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 cd 32 00 00       	call   3996 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 b3 32 00 00       	call   399e <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 97 40 00 00       	push   $0x4097
     6f4:	e8 bd 32 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 54 32 00 00       	call   398e <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 48 32 00 00       	call   399e <close>
  if(unlink("big") < 0){
     756:	c7 04 24 97 40 00 00 	movl   $0x4097,(%esp)
     75d:	e8 64 32 00 00       	call   39c6 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 9c 5f 00 00    	push   0x5f9c
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 2b 31 00 00       	call   39b6 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 0b 31 00 00       	call   399e <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 00 31 00 00       	call   39c6 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 9c 5f 00 00    	push   0x5f9c
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 c0 30 00 00       	call   39e6 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 a8 30 00 00       	call   39e6 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 74 30 00 00       	call   39c6 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 9c 5f 00 00    	push   0x5f9c
     97e:	e8 5d 31 00 00       	call   3ae0 <printf>
    exit();
     983:	e8 ee 2f 00 00       	call   3976 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 01 41 00 00       	push   $0x4101
     98f:	ff 35 9c 5f 00 00    	push   0x5f9c
     995:	e8 46 31 00 00       	call   3ae0 <printf>
    exit();
     99a:	e8 d7 2f 00 00       	call   3976 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 f0 40 00 00       	push   $0x40f0
     9a6:	ff 35 9c 5f 00 00    	push   0x5f9c
     9ac:	e8 2f 31 00 00       	call   3ae0 <printf>
    exit();
     9b1:	e8 c0 2f 00 00       	call   3976 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 dd 40 00 00       	push   $0x40dd
     9bd:	ff 35 9c 5f 00 00    	push   0x5f9c
     9c3:	e8 18 31 00 00       	call   3ae0 <printf>
    exit();
     9c8:	e8 a9 2f 00 00       	call   3976 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 9c 5f 00 00    	push   0x5f9c
     9e1:	e8 fa 30 00 00       	call   3ae0 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 a0 5f 00 00       	push   $0x5fa0
     9ed:	68 ed 3e 00 00       	push   $0x3eed
     9f2:	e8 b7 2f 00 00       	call   39ae <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 9c 5f 00 00    	push   0x5f9c
     a0d:	e8 ce 30 00 00       	call   3ae0 <printf>
    exit();
     a12:	e8 5f 2f 00 00       	call   3976 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 3c 2f 00 00       	call   399e <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 11 2f 00 00       	call   398e <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 c2 2e 00 00       	call   399e <close>
     ...
     b11:	e8 80 2e 00 00       	call   3996 <write>
    ...
    exit();
     b28:	e8 49 2e 00 00       	call   3976 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 5d 2e 00 00       	call   399e <close>
    wait();
     b41:	e8 38 2e 00 00       	call   397e <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 74 2f 00 00       	call   3ae0 <printf>
      exit();
     b6c:	e8 05 2e 00 00       	call   3976 <exit>
    ...
    exit();
     b7f:	e8 f2 2d 00 00       	call   3976 <exit>
    ...
    exit();
     b92:	e8 df 2d 00 00       	call   3976 <exit>
     ...
     ba0:	e8 3b 2f 00 00       	call   3ae0 <printf>
        exit();
     ba5:	e8 cc 2d 00 00       	call   3976 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 a4 2d 00 00       	call   396e <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 8f 2d 00 00       	call   396e <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 8a 2d 00 00       	call   3986 <pipe>
  pid3 = fork();
     bfc:	e8 6d 2d 00 00       	call   396e <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 60 2d 00 00       	call   399e <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 23 2d 00 00       	call   399e <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 15 2d 00 00       	call   39a6 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 0d 2d 00 00       	call   39a6 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 05 2d 00 00       	call   39a6 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 ca 2c 00 00       	call   397e <wait>
  wait();
     cb4:	e8 c5 2c 00 00       	call   397e <wait>
  wait();
     cb9:	e8 c0 2c 00 00       	call   397e <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 57 2c 00 00       	call   397e <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 39 2c 00 00       	call   396e <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 e7 2b 00 00       	call   3976 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 4b 2c 00 00       	call   39f6 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 bc 2b 00 00       	call   396e <fork>
    ...
    exit();
     e1f:	e8 52 2b 00 00       	call   3976 <exit>
     ...
     e3a:	e8 67 2b 00 00       	call   39a6 <kill>
      exit();
     e3f:	e8 32 2b 00 00       	call   3976 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 2b 2b 00 00       	jmp    397e <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 45 2b 00 00       	call   39c6 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 43 42 00 00       	push   $0x4243
     e8d:	e8 24 2b 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 c2 2a 00 00       	call   396e <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 b5 2a 00 00       	call   3996 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 73 2a 00 00       	call   397e <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 85 2a 00 00       	call   399e <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 43 42 00 00       	push   $0x4243
     f22:	e8 8f 2a 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 3d 2a 00 00       	call   398e <read>
  ...
  close(fd);
     ...
     f86:	e8 13 2a 00 00       	call   399e <close>
  unlink("sharedfd");
     f8b:	c7 04 24 43 42 00 00 	movl   $0x4243,(%esp)
     f92:	e8 2f 2a 00 00       	call   39c6 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 76 29 00 00       	call   3976 <exit>
    ...
    exit();
    100e:	e8 63 29 00 00       	call   3976 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 62 29 00 00       	call   39c6 <unlink>
    pid = fork();
    1064:	e8 05 29 00 00       	call   396e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 f1 28 00 00       	call   397e <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 ea 28 00 00       	call   397e <wait>
    1094:	e8 e5 28 00 00       	call   397e <wait>
    1099:	e8 e0 28 00 00       	call   397e <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 04 29 00 00       	call   39b6 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 b9 28 00 00       	call   398e <read>
    ...
    1104:	e8 95 28 00 00       	call   399e <close>
    if(total != 12*500){
    ...
    111e:	e8 a3 28 00 00       	call   39c6 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 82 29 00 00       	call   3ae0 <printf>
          exit();
    115e:	e8 13 28 00 00       	call   3976 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 45 28 00 00       	call   39b6 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 eb 27 00 00       	call   3996 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 b7 27 00 00       	call   3976 <exit>
    ...
    11c8:	e8 13 29 00 00       	call   3ae0 <printf>
        exit();
    11cd:	e8 a4 27 00 00       	call   3976 <exit>
    ...
    11e2:	e8 f9 28 00 00       	call   3ae0 <printf>
      exit();
    11e7:	e8 8a 27 00 00       	call   3976 <exit>
    ...
    11f5:	e8 e6 28 00 00       	call   3ae0 <printf>
      exit();
    11fa:	e8 77 27 00 00       	call   3976 <exit>
    ...
    1208:	e8 d3 28 00 00       	call   3ae0 <printf>
          exit();
    120d:	e8 64 27 00 00       	call   3976 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 2f 27 00 00       	call   396e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 24 27 00 00       	call   397e <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 1a 27 00 00       	call   397e <wait>
    1264:	e8 15 27 00 00       	call   397e <wait>
    1269:	e8 10 27 00 00       	call   397e <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 08 27 00 00       	call   39b6 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 cc 26 00 00       	call   399e <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 b6 26 00 00       	call   39c6 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 8e 27 00 00       	call   3ae0 <printf>
        exit();
    1352:	e8 1f 26 00 00       	call   3976 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 17 26 00 00       	call   39b6 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 ef 25 00 00       	call   399e <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 f8 25 00 00       	call   39c6 <unlink>
    ...
    13de:	e8 fd 26 00 00       	call   3ae0 <printf>
            exit();
    13e3:	e8 8e 25 00 00       	call   3976 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 81 25 00 00       	call   3976 <exit>
    ...
    1400:	e8 db 26 00 00       	call   3ae0 <printf>
        exit();
    1405:	e8 6c 25 00 00       	call   3976 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 c7 26 00 00       	call   3ae0 <printf>
      exit();
    1419:	e8 58 25 00 00       	call   3976 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 b3 26 00 00       	call   3ae0 <printf>
          exit();
    142d:	e8 44 25 00 00       	call   3976 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 51 25 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 14 25 00 00       	call   3996 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 14 25 00 00       	call   399e <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 f5 42 00 00       	push   $0x42f5
    1493:	e8 1e 25 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 14 25 00 00       	call   39c6 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 e7 24 00 00       	call   39b6 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 75 24 00 00       	call   3996 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 6c 24 00 00       	call   399e <close>
  unlink("unlinkread");
    1532:	c7 04 24 f5 42 00 00 	movl   $0x42f5,(%esp)
    1539:	e8 88 24 00 00       	call   39c6 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 0d 24 00 00       	call   3976 <exit>
    ...
    exit();
    1577:	e8 fa 23 00 00       	call   3976 <exit>
    ...
    exit();
    158a:	e8 e7 23 00 00       	call   3976 <exit>
    ...
    exit();
    159d:	e8 d4 23 00 00       	call   3976 <exit>
    ...
    exit();
    15b0:	e8 c1 23 00 00       	call   3976 <exit>
    ...
    exit();
    15c3:	e8 ae 23 00 00       	call   3976 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 6d 23 00 00       	call   3996 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 60 23 00 00       	call   399e <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ba 43 00 00       	push   $0x43ba
    1645:	68 b6 43 00 00       	push   $0x43b6
    164a:	e8 87 23 00 00       	call   39d6 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 5f 23 00 00       	call   39c6 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 b6 43 00 00       	push   $0x43b6
    1670:	e8 41 23 00 00       	call   39b6 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 27 23 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 df 22 00 00       	call   398e <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 da 22 00 00       	call   399e <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ba 43 00 00       	push   $0x43ba
    16cb:	68 ba 43 00 00       	push   $0x43ba
    16d0:	e8 01 23 00 00       	call   39d6 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 d9 22 00 00       	call   39c6 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 b6 43 00 00       	push   $0x43b6
    16f4:	68 ba 43 00 00       	push   $0x43ba
    16f9:	e8 d8 22 00 00       	call   39d6 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 bf 22 00 00       	call   39d6 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 2e 22 00 00       	call   3976 <exit>
    ...
    exit();
    1756:	e8 1b 22 00 00       	call   3976 <exit>
    ...
    exit();
    1769:	e8 08 22 00 00       	call   3976 <exit>
    ...
    exit();
    177c:	e8 f5 21 00 00       	call   3976 <exit>
    ...
    exit();
    178f:	e8 e2 21 00 00       	call   3976 <exit>
    ...
    exit();
    17a2:	e8 cf 21 00 00       	call   3976 <exit>
    ...
    exit();
    17b5:	e8 bc 21 00 00       	call   3976 <exit>
    ...
    exit();
    17c8:	e8 a9 21 00 00       	call   3976 <exit>
    ...
    exit();
    17db:	e8 96 21 00 00       	call   3976 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 87 21 00 00       	call   39b6 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 5c 21 00 00       	call   399e <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 34 21 00 00       	call   397e <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 64 21 00 00       	call   39c6 <unlink>
    pid = fork();
    1862:	e8 07 21 00 00       	call   396e <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 2c 21 00 00       	call   39b6 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 f5 20 00 00       	call   39d6 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 95 20 00 00       	call   397e <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 a3 20 00 00       	call   39b6 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 62 20 00 00       	call   398e <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 25 20 00 00       	call   399e <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 24 20 00 00       	call   39c6 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 1c 20 00 00       	call   39c6 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 14 20 00 00       	call   39c6 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 0c 20 00 00       	call   39c6 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 b4 1f 00 00       	call   397e <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 8d 1f 00 00       	call   396e <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 a6 1f 00 00       	call   39b6 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 86 1f 00 00       	call   399e <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 94 1f 00 00       	call   39b6 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 74 1f 00 00       	call   399e <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 82 1f 00 00       	call   39b6 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 62 1f 00 00       	call   399e <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 70 1f 00 00       	call   39b6 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 50 1f 00 00       	call   399e <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 5a 20 00 00       	call   3ae0 <printf>
      exit();
    1a86:	e8 eb 1e 00 00       	call   3976 <exit>
    ...
    exit();
    1a99:	e8 d8 1e 00 00       	call   3976 <exit>
    ...
    1aac:	e8 2f 20 00 00       	call   3ae0 <printf>
        exit();
    1ab1:	e8 c0 1e 00 00       	call   3976 <exit>
    ...
    1ac4:	e8 17 20 00 00       	call   3ae0 <printf>
        exit();
    1ac9:	e8 a8 1e 00 00       	call   3976 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 c7 1e 00 00       	call   399e <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 c5 1e 00 00       	call   39c6 <unlink>
  pid = fork();
    1b01:	e8 68 1e 00 00       	call   396e <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 84 1e 00 00       	call   39c6 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 3b 1e 00 00       	call   39b6 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 1b 1e 00 00       	call   399e <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 e7 1d 00 00       	call   397e <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 14 1e 00 00       	call   39d6 <link>
    ...
    exit();
    1bd8:	e8 99 1d 00 00       	call   3976 <exit>
    exit();
    1bdd:	e8 94 1d 00 00       	call   3976 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 b5 1d 00 00       	call   39c6 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 05 45 00 00       	push   $0x4505
    1c1d:	e8 94 1d 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 63 1d 00 00       	call   399e <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 6a 1d 00 00       	call   39d6 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 39 1d 00 00       	call   39c6 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 0f 1d 00 00       	call   39c6 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 ee 1d 00 00       	call   3ae0 <printf>
      exit();
    1cf2:	e8 7f 1c 00 00       	call   3976 <exit>
    ...
    1d01:	e8 da 1d 00 00       	call   3ae0 <printf>
      exit();
    1d06:	e8 6b 1c 00 00       	call   3976 <exit>
    ...
    exit();
    1d19:	e8 58 1c 00 00       	call   3976 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 87 1c 00 00       	call   39c6 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 78 46 00 00 	movl   $0x4678,(%esp)
    1d46:	e8 93 1c 00 00       	call   39de <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 4e 1c 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 11 1c 00 00       	call   3996 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 11 1c 00 00       	call   399e <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 78 46 00 00 	movl   $0x4678,(%esp)
    1d94:	e8 2d 1c 00 00       	call   39c6 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 2d 1c 00 00       	call   39de <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 e8 1b 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 ab 1b 00 00       	call   3996 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 ab 1b 00 00       	call   399e <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 d2 45 00 00       	push   $0x45d2
    1dfc:	e8 b5 1b 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 6d 1b 00 00       	call   398e <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 5b 1b 00 00       	call   399e <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 12 46 00 00       	push   $0x4612
    1e4a:	68 ae 45 00 00       	push   $0x45ae
    1e4f:	e8 82 1b 00 00       	call   39d6 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 5a 1b 00 00       	call   39c6 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 30 1b 00 00       	call   39b6 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 48 1b 00 00       	call   39e6 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 30 1b 00 00       	call   39e6 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 18 1b 00 00       	call   39e6 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 00 1b 00 00       	call   39e6 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 b6 1a 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 6e 1a 00 00       	call   398e <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 69 1a 00 00       	call   399e <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 ae 45 00 00       	push   $0x45ae
    1f3e:	e8 73 1a 00 00       	call   39b6 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 56 1a 00 00       	call   39b6 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 39 1a 00 00       	call   39b6 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 1c 1a 00 00       	call   39b6 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 02 1a 00 00       	call   39b6 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 e8 19 00 00       	call   39b6 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 eb 19 00 00       	call   39d6 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 ce 19 00 00       	call   39d6 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 b1 19 00 00       	call   39d6 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 a1 19 00 00       	call   39de <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 89 19 00 00       	call   39de <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 71 19 00 00       	call   39de <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 41 19 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 29 19 00 00       	call   39c6 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 31 19 00 00       	call   39e6 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 19 19 00 00       	call   39e6 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 e1 18 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 c9 18 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 b1 18 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 99 18 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 81 18 00 00       	call   39c6 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 fc 17 00 00       	call   3976 <exit>
    ...
    exit();
    2188:	e8 e9 17 00 00       	call   3976 <exit>
    ...
    exit();
    219b:	e8 d6 17 00 00       	call   3976 <exit>
    ...
    exit();
    21ae:	e8 c3 17 00 00       	call   3976 <exit>
    ...
    exit();
    21c1:	e8 b0 17 00 00       	call   3976 <exit>
    ...
    exit();
    21d4:	e8 9d 17 00 00       	call   3976 <exit>
    ...
    exit();
    21e7:	e8 8a 17 00 00       	call   3976 <exit>
    ...
    exit();
    21fa:	e8 77 17 00 00       	call   3976 <exit>
    ...
    exit();
    220d:	e8 64 17 00 00       	call   3976 <exit>
    ...
    exit();
    2220:	e8 51 17 00 00       	call   3976 <exit>
    ...
    exit();
    2233:	e8 3e 17 00 00       	call   3976 <exit>
    ...
    exit();
    2246:	e8 2b 17 00 00       	call   3976 <exit>
    ...
    exit();
    2259:	e8 18 17 00 00       	call   3976 <exit>
    ...
    exit();
    226c:	e8 05 17 00 00       	call   3976 <exit>
    ...
    exit();
    227f:	e8 f2 16 00 00       	call   3976 <exit>
    ...
    exit();
    2292:	e8 df 16 00 00       	call   3976 <exit>
    ...
    exit();
    22a5:	e8 cc 16 00 00       	call   3976 <exit>
    ...
    exit();
    22b8:	e8 b9 16 00 00       	call   3976 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 a6 16 00 00       	call   3976 <exit>
    ...
    exit();
    22de:	e8 93 16 00 00       	call   3976 <exit>
    ...
    exit();
    22f1:	e8 80 16 00 00       	call   3976 <exit>
    ...
    exit();
    2304:	e8 6d 16 00 00       	call   3976 <exit>
    ...
    exit();
    2317:	e8 5a 16 00 00       	call   3976 <exit>
    ...
    exit();
    232a:	e8 47 16 00 00       	call   3976 <exit>
    ...
    exit();
    233d:	e8 34 16 00 00       	call   3976 <exit>
    ...
    exit();
    2350:	e8 21 16 00 00       	call   3976 <exit>
    ...
    exit();
    2363:	e8 0e 16 00 00       	call   3976 <exit>
    ...
    exit();
    2376:	e8 fb 15 00 00       	call   3976 <exit>
    ...
    exit();
    2389:	e8 e8 15 00 00       	call   3976 <exit>
    ...
    exit();
    239c:	e8 d5 15 00 00       	call   3976 <exit>
    ...
    exit();
    23af:	e8 c2 15 00 00       	call   3976 <exit>
    ...
    exit();
    23c2:	e8 af 15 00 00       	call   3976 <exit>
    ...
    exit();
    23d5:	e8 9c 15 00 00       	call   3976 <exit>
    ...
    exit();
    23e8:	e8 89 15 00 00       	call   3976 <exit>
    ...
    exit();
    23fb:	e8 76 15 00 00       	call   3976 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 a1 15 00 00       	call   39c6 <unlink>
    ...
    243d:	e8 74 15 00 00       	call   39b6 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 3c 15 00 00       	call   3996 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 26 15 00 00       	call   3996 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 18 15 00 00       	call   399e <close>
    unlink("bigwrite");
    2486:	c7 04 24 74 48 00 00 	movl   $0x4874,(%esp)
    248d:	e8 34 15 00 00       	call   39c6 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 1c 16 00 00       	call   3ae0 <printf>
        exit();
    24c4:	e8 ad 14 00 00       	call   3976 <exit>
    ...
    24d3:	e8 08 16 00 00       	call   3ae0 <printf>
      exit();
    24d8:	e8 99 14 00 00       	call   3976 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 c5 14 00 00       	call   39c6 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 d0 48 00 00       	push   $0x48d0
    250d:	e8 a4 14 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 48 14 00 00       	call   3996 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 31 14 00 00       	call   399e <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 d0 48 00 00       	push   $0x48d0
    2576:	e8 3b 14 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 bd 13 00 00       	call   398e <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 bb 13 00 00       	call   399e <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 c7 13 00 00       	call   39c6 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 b9 14 00 00       	call   3ae0 <printf>
      exit();
    2627:	e8 4a 13 00 00       	call   3976 <exit>
    ...
    2636:	e8 a5 14 00 00       	call   3ae0 <printf>
      exit();
    263b:	e8 36 13 00 00       	call   3976 <exit>
    ...
    264a:	e8 91 14 00 00       	call   3ae0 <printf>
      exit();
    264f:	e8 22 13 00 00       	call   3976 <exit>
    ...
    265e:	e8 7d 14 00 00       	call   3ae0 <printf>
      exit();
    2663:	e8 0e 13 00 00       	call   3976 <exit>
    ...
    exit();
    2676:	e8 fb 12 00 00       	call   3976 <exit>
    ...
    exit();
    2689:	e8 e8 12 00 00       	call   3976 <exit>
    ...
    exit();
    269c:	e8 d5 12 00 00       	call   3976 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 10 13 00 00       	call   39de <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 f8 12 00 00       	call   39de <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 b3 12 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 87 12 00 00       	call   399e <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 28 52 00 00       	push   $0x5228
    2720:	e8 91 12 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 69 12 00 00       	call   399e <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 9c 49 00 00 	movl   $0x499c,(%esp)
    273c:	e8 9d 12 00 00       	call   39de <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 89 12 00 00       	call   39de <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 f3 11 00 00       	call   3976 <exit>
    ...
    exit();
    2791:	e8 e0 11 00 00       	call   3976 <exit>
    ...
    exit();
    27a4:	e8 cd 11 00 00       	call   3976 <exit>
    ...
    exit();
    27b7:	e8 ba 11 00 00       	call   3976 <exit>
    ...
    exit();
    27ca:	e8 a7 11 00 00       	call   3976 <exit>
    ...
    exit();
    27dd:	e8 94 11 00 00       	call   3976 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 d0 11 00 00       	call   39de <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 c0 11 00 00       	call   39e6 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 88 11 00 00       	call   39c6 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 70 11 00 00       	call   39c6 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 78 11 00 00       	call   39e6 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 40 11 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 2c 11 00 00       	call   39c6 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 18 11 00 00       	call   39c6 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 9a 10 00 00       	call   3976 <exit>
    ...
    exit();
    28ea:	e8 87 10 00 00       	call   3976 <exit>
    ...
    exit();
    28fd:	e8 74 10 00 00       	call   3976 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 61 10 00 00       	call   3976 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 4e 10 00 00       	call   3976 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 3b 10 00 00       	call   3976 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 28 10 00 00       	call   3976 <exit>
    ...
    exit();
    295c:	e8 15 10 00 00       	call   3976 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 22 10 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 f6 0f 00 00       	call   399e <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 85 4a 00 00 	movl   $0x4a85,(%esp)
    29af:	e8 32 10 00 00       	call   39e6 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 e8 0f 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 cb 0f 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 db 0f 00 00       	call   39de <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 ab 0f 00 00       	call   39c6 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 9e 0f 00 00       	call   39d6 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 76 0f 00 00       	call   39c6 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 4c 0f 00 00       	call   39b6 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 32 0f 00 00       	call   39b6 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 00 0f 00 00       	call   3996 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 f8 0e 00 00       	call   399e <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 a7 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2add:	e8 94 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2af0:	e8 81 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b03:	e8 6e 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b16:	e8 5b 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b29:	e8 48 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b3c:	e8 35 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b4f:	e8 22 0e 00 00       	call   3976 <exit>
    ...
    exit();
    2b62:	e8 0f 0e 00 00       	call   3976 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 41 0e 00 00       	call   39de <mkdir>
    ...
    2bb0:	e8 31 0e 00 00       	call   39e6 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 7a 0d 00 00       	call   399e <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 60 47 00 00       	push   $0x4760
    2c2f:	e8 92 0d 00 00       	call   39c6 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 99 0d 00 00       	call   39e6 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 6e 0e 00 00       	call   3ae0 <printf>
      exit();
    2c72:	e8 ff 0c 00 00       	call   3976 <exit>
    ...
    2c81:	e8 5a 0e 00 00       	call   3ae0 <printf>
      exit();
    2c86:	e8 eb 0c 00 00       	call   3976 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 ac 0c 00 00       	call   396e <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 a9 0c 00 00       	call   397e <wait>
  ...
  if(wait() != -1){
    2cde:	e8 9b 0c 00 00       	call   397e <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 75 0c 00 00       	call   3976 <exit>
    ...
    2d0b:	e8 d0 0d 00 00       	call   3ae0 <printf>
      exit();
    2d10:	e8 61 0c 00 00       	call   3976 <exit>
    ...
    exit();
    2d23:	e8 4e 0c 00 00       	call   3976 <exit>
    ...
    exit();
    2d36:	e8 3b 0c 00 00       	call   3976 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 72 0c 00 00       	call   39fe <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 c1 0b 00 00       	call   396e <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 3a 0c 00 00       	call   39fe <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 2e 0c 00 00       	call   39fe <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 96 0b 00 00       	call   397e <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 0c 0c 00 00       	call   39fe <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 fb 0b 00 00       	call   39fe <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 e6 0b 00 00       	call   39fe <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 d8 0b 00 00       	call   39fe <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 c2 0b 00 00       	call   39fe <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 a7 0b 00 00       	call   39fe <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 99 0b 00 00       	call   39fe <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 82 0b 00 00       	call   39fe <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 19 0b 00 00       	call   39f6 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 8a 0a 00 00       	call   396e <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 87 0a 00 00       	call   397e <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 75 0a 00 00       	call   3986 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 41 0a 00 00       	call   396e <fork>
    ...
    2f48:	e8 41 0a 00 00       	call   398e <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 9a 0a 00 00       	call   39fe <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 26 0a 00 00       	call   39a6 <kill>
    wait();
    2f80:	e8 f9 09 00 00       	call   397e <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 5c 0a 00 00       	call   39fe <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 a0 4c 00 00       	push   $0x4ca0
    2fb2:	ff 35 9c 5f 00 00    	push   0x5f9c
    2fb8:	e8 23 0b 00 00       	call   3ae0 <printf>
}
    ...
    exit();
    310c:	e8 65 08 00 00       	call   3976 <exit>
    exit();
    3111:	e8 60 08 00 00       	call   3976 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 35 4c 00 00       	push   $0x4c35
    311d:	ff 35 9c 5f 00 00    	push   0x5f9c
    3123:	e8 b8 09 00 00       	call   3ae0 <printf>
    exit();
    3128:	e8 49 08 00 00       	call   3976 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 f4 53 00 00       	push   $0x53f4
    3134:	ff 35 9c 5f 00 00    	push   0x5f9c
    313a:	e8 a1 09 00 00       	call   3ae0 <printf>
    exit();
    313f:	e8 32 08 00 00       	call   3976 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 bc 53 00 00       	push   $0x53bc
    314b:	ff 35 9c 5f 00 00    	push   0x5f9c
    3151:	e8 8a 09 00 00       	call   3ae0 <printf>
    exit();
    3156:	e8 1b 08 00 00       	call   3976 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 51 4c 00 00       	push   $0x4c51
    3162:	ff 35 9c 5f 00 00    	push   0x5f9c
    3168:	e8 73 09 00 00       	call   3ae0 <printf>
    exit();
    316d:	e8 04 08 00 00       	call   3976 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 41 08 00 00       	call   3a06 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 35 08 00 00       	call   3a06 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 cd 07 00 00       	call   39a6 <kill>
    wait();
    31d9:	e8 a0 07 00 00       	call   397e <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 bd 4c 00 00       	push   $0x4cbd
    31e6:	e8 eb 07 00 00       	call   39d6 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 53 07 00 00       	call   3976 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 c8 4c 00 00       	push   $0x4cc8
    322b:	ff 35 9c 5f 00 00    	push   0x5f9c
    3231:	e8 aa 08 00 00       	call   3ae0 <printf>
      exit();
    3236:	e8 3b 07 00 00       	call   3976 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 9c 5f 00 00    	push   0x5f9c
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    3293:	ff 35 9c 5f 00 00    	push   0x5f9c
    3299:	e8 42 08 00 00       	call   3ae0 <printf>
      exit();
    329e:	e8 d3 06 00 00       	call   3976 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 06 07 00 00       	call   39c6 <unlink>
  pid = fork();
    32c0:	e8 a9 06 00 00       	call   396e <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 a7 06 00 00       	call   397e <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 16 4d 00 00       	push   $0x4d16
    32e1:	e8 d0 06 00 00       	call   39b6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 a4 06 00 00       	call   399e <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 16 4d 00 00 	movl   $0x4d16,(%esp)
    3301:	e8 c0 06 00 00       	call   39c6 <unlink>
}
    ...
    3310:	c7 04 85 e0 a6 00 00 	movl   $0x5470,0xa6e0(,%eax,4)
    3317:	70 54 00 00 
    ...
    332a:	ff 35 9c 5f 00 00    	push   0x5f9c
    args[MAXARG-1] = 0;
    ...
    334b:	e8 5e 06 00 00       	call   39ae <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 2d 4d 00 00       	push   $0x4d2d
    3357:	ff 35 9c 5f 00 00    	push   0x5f9c
    ...
    336e:	e8 43 06 00 00       	call   39b6 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 23 06 00 00       	call   399e <close>
    exit();
    337b:	e8 f6 05 00 00       	call   3976 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 56 4d 00 00       	push   $0x4d56
    3387:	ff 35 9c 5f 00 00    	push   0x5f9c
    338d:	e8 4e 07 00 00       	call   3ae0 <printf>
    exit();
    3392:	e8 df 05 00 00       	call   3976 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 3d 4d 00 00       	push   $0x4d3d
    339e:	ff 35 9c 5f 00 00    	push   0x5f9c
    33a4:	e8 37 07 00 00       	call   3ae0 <printf>
    exit();
    33a9:	e8 c8 05 00 00       	call   3976 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 58 05 00 00       	call   39b6 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 11 05 00 00       	call   3996 <write>
      if(cc < 512)
    ...
    34a2:	e8 f7 04 00 00       	call   399e <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 75 04 00 00       	call   39c6 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 d7 03 00 00       	call   396e <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 d9 03 00 00       	call   397e <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 99 03 00 00       	call   3976 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 86 03 00 00       	call   3976 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 b3 03 00 00       	call   39b6 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 e8 03 00 00       	call   39fe <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 69 03 00 00       	call   398e <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 71 03 00 00       	call   399e <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for (i = 0; i + 1 < max;)
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 d1 01 00 00       	call   398e <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 94 01 00 00       	call   39b6 <open>
  if (fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 97 01 00 00       	call   39ce <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 5d 01 00 00       	call   399e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  void *stack = malloc(4096 * 2);
    ...
    38db:	e8 30 04 00 00       	call   3d10 <malloc>
  ...
  pid = clone(start_routine, arg1, arg2, stack);
    ...
    38ea:	e8 27 01 00 00       	call   3a16 <clone>
...
int thread_join()
{
    ...
    3903:	53                   	push   %ebx
    3904:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
    3907:	6a 04                	push   $0x4
    3909:	e8 02 04 00 00       	call   3d10 <malloc>
    390e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
    3911:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3914:	89 04 24             	mov    %eax,(%esp)
    3917:	e8 02 01 00 00       	call   3a1e <join>
    391c:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
    391e:	58                   	pop    %eax
    391f:	ff 75 f4             	push   -0xc(%ebp)
    3922:	e8 59 03 00 00       	call   3c80 <free>
  lock_release(&lock);

  return pid;
}
    3927:	89 d8                	mov    %ebx,%eax
    3929:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    392c:	c9                   	leave  
    392d:	c3                   	ret    
...
void lock_acquire(lock_t *lock)
{
  ...
  while (lock->flag == 1)
    3936:	83 38 01             	cmpl   $0x1,(%eax)
    3939:	75 05                	jne    3940 <lock_acquire+0x10>
    393b:	eb fe                	jmp    393b <lock_acquire+0xb>
    393d:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
    3940:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
    3946:	5d                   	pop    %ebp
    3947:	c3                   	ret    
...
00003960 <lock_init>:
    ...
    3966:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    396c:	5d                   	pop    %ebp
    396d:	c3                   	ret    
...
SYSCALL(fork)
    396e:	b8 01 00 00 00       	mov    $0x1,%eax
    3973:	cd 40                	int    $0x40
    3975:	c3                   	ret    

00003976 <exit>:
SYSCALL(exit)
    3976:	b8 02 00 00 00       	mov    $0x2,%eax
    397b:	cd 40                	int    $0x40
    397d:	c3                   	ret    

0000397e <wait>:
SYSCALL(wait)
    397e:	b8 03 00 00 00       	mov    $0x3,%eax
    3983:	cd 40                	int    $0x40
    3985:	c3                   	ret    

00003986 <pipe>:
SYSCALL(pipe)
    3986:	b8 04 00 00 00       	mov    $0x4,%eax
    398b:	cd 40                	int    $0x40
    398d:	c3                   	ret    

0000398e <read>:
SYSCALL(read)
    398e:	b8 05 00 00 00       	mov    $0x5,%eax
    3993:	cd 40                	int    $0x40
    3995:	c3                   	ret    

00003996 <write>:
SYSCALL(write)
    3996:	b8 10 00 00 00       	mov    $0x10,%eax
    399b:	cd 40                	int    $0x40
    399d:	c3                   	ret    

0000399e <close>:
SYSCALL(close)
    399e:	b8 15 00 00 00       	mov    $0x15,%eax
    39a3:	cd 40                	int    $0x40
    39a5:	c3                   	ret    

000039a6 <kill>:
SYSCALL(kill)
    39a6:	b8 06 00 00 00       	mov    $0x6,%eax
    39ab:	cd 40                	int    $0x40
    39ad:	c3                   	ret    

000039ae <exec>:
SYSCALL(exec)
    39ae:	b8 07 00 00 00       	mov    $0x7,%eax
    39b3:	cd 40                	int    $0x40
    39b5:	c3                   	ret    

000039b6 <open>:
SYSCALL(open)
    39b6:	b8 0f 00 00 00       	mov    $0xf,%eax
    39bb:	cd 40                	int    $0x40
    39bd:	c3                   	ret    

000039be <mknod>:
SYSCALL(mknod)
    39be:	b8 11 00 00 00       	mov    $0x11,%eax
    39c3:	cd 40                	int    $0x40
    39c5:	c3                   	ret    

000039c6 <unlink>:
SYSCALL(unlink)
    39c6:	b8 12 00 00 00       	mov    $0x12,%eax
    39cb:	cd 40                	int    $0x40
    39cd:	c3                   	ret    

000039ce <fstat>:
SYSCALL(fstat)
    39ce:	b8 08 00 00 00       	mov    $0x8,%eax
    39d3:	cd 40                	int    $0x40
    39d5:	c3                   	ret    

000039d6 <link>:
SYSCALL(link)
    39d6:	b8 13 00 00 00       	mov    $0x13,%eax
    39db:	cd 40                	int    $0x40
    39dd:	c3                   	ret    

000039de <mkdir>:
SYSCALL(mkdir)
    39de:	b8 14 00 00 00       	mov    $0x14,%eax
    39e3:	cd 40                	int    $0x40
    39e5:	c3                   	ret    

000039e6 <chdir>:
SYSCALL(chdir)
    39e6:	b8 09 00 00 00       	mov    $0x9,%eax
    39eb:	cd 40                	int    $0x40
    39ed:	c3                   	ret    

000039ee <dup>:
SYSCALL(dup)
    39ee:	b8 0a 00 00 00       	mov    $0xa,%eax
    39f3:	cd 40                	int    $0x40
    39f5:	c3                   	ret    

000039f6 <getpid>:
SYSCALL(getpid)
    39f6:	b8 0b 00 00 00       	mov    $0xb,%eax
    39fb:	cd 40                	int    $0x40
    39fd:	c3                   	ret    

000039fe <sbrk>:
SYSCALL(sbrk)
    39fe:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a03:	cd 40                	int    $0x40
    3a05:	c3                   	ret    

00003a06 <sleep>:
SYSCALL(sleep)
    3a06:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a0b:	cd 40                	int    $0x40
    3a0d:	c3                   	ret    

00003a0e <uptime>:
SYSCALL(uptime)
    3a0e:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a13:	cd 40                	int    $0x40
    3a15:	c3                   	ret    

00003a16 <clone>:
SYSCALL(clone)
    3a16:	b8 16 00 00 00       	mov    $0x16,%eax
    3a1b:	cd 40                	int    $0x40
    3a1d:	c3                   	ret    

00003a1e <join>:
    3a1e:	b8 17 00 00 00       	mov    $0x17,%eax
    3a23:	cd 40                	int    $0x40
    3a25:	c3                   	ret    
    3a26:	66 90                	xchg   %ax,%ax
    3a28:	66 90                	xchg   %ax,%ax
    ...
    3a3c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a69:	0f b6 92 00 56 00 00 	movzbl 0x5600(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    3aae:	56                   	push   %esi
    3aaf:	57                   	push   %edi
    3ab0:	e8 e1 fe ff ff       	call   3996 <write>
  while(--i >= 0)
    ...
    3ae9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b25:	57                   	push   %edi
    3b26:	56                   	push   %esi
    3b27:	e8 6a fe ff ff       	call   3996 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b59:	ff 24 85 a8 55 00 00 	jmp    *0x55a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3b7e:	e8 13 fe ff ff       	call   3996 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b8f:	57                   	push   %edi
    3b90:	56                   	push   %esi
    3b91:	e8 00 fe ff ff       	call   3996 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3bfb:	57                   	push   %edi
    3bfc:	56                   	push   %esi
    3bfd:	e8 94 fd ff ff       	call   3996 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c3f:	e8 52 fd ff ff       	call   3996 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c67:	90                   	nop
          s = "(null)";
    3c68:	ba 9e 55 00 00       	mov    $0x559e,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c81:	a1 60 a7 00 00       	mov    0xa760,%eax
{
  ...
  freep = p;
    ...
    3cc1:	5b                   	pop    %ebx
  freep = p;
    3cc2:	89 15 60 a7 00 00    	mov    %edx,0xa760
}
    3cc8:	5e                   	pop    %esi
    3cc9:	5f                   	pop    %edi
    3cca:	5d                   	pop    %ebp
  ...
  freep = p;
    3cfc:	89 15 60 a7 00 00    	mov    %edx,0xa760
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d1c:	8b 3d 60 a7 00 00    	mov    0xa760,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3d8f:	8b 15 60 a7 00 00    	mov    0xa760,%edx
    ...
    3dbc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3dbf:	89 15 60 a7 00 00    	mov    %edx,0xa760
}
    ...
    3dcf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3dd0:	c7 05 60 a7 00 00 64 	movl   $0xa764,0xa760
    3dd7:	a7 00 00 
    base.s.size = 0;
    3dda:	bf 64 a7 00 00       	mov    $0xa764,%edi
    base.s.ptr = freep = prevp = &base;
    3ddf:	c7 05 64 a7 00 00 64 	movl   $0xa764,0xa764
    3de6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3de9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3deb:	c7 05 68 a7 00 00 00 	movl   $0x0,0xa768
    3df2:	00 00 00 
    if(p->s.size >= nunits){
