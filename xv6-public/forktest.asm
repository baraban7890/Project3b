...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 38a:	e8 27 01 00 00       	call   4b6 <clone>
...
int thread_join()
{
 ...
 3a3:	53                   	push   %ebx
 3a4:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 3a7:	6a 04                	push   $0x4
 3a9:	e8 b2 01 00 00       	call   560 <malloc>
 3ae:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 3b1:	8d 45 f4             	lea    -0xc(%ebp),%eax
 3b4:	89 04 24             	mov    %eax,(%esp)
 3b7:	e8 02 01 00 00       	call   4be <join>
 3bc:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 3be:	58                   	pop    %eax
 3bf:	ff 75 f4             	push   -0xc(%ebp)
 3c2:	e8 09 01 00 00       	call   4d0 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 3d3:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 3d6:	83 38 01             	cmpl   $0x1,(%eax)
 3d9:	75 05                	jne    3e0 <lock_acquire+0x10>
 3db:	eb fe                	jmp    3db <lock_acquire+0xb>
 3dd:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 3e0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 3e6:	5d                   	pop    %ebp
 3e7:	c3                   	ret    
...
free(void *ap)
{
 ...
 4d1:	a1 d4 09 00 00       	mov    0x9d4,%eax
{
 ...
 511:	5b                   	pop    %ebx
  freep = p;
 512:	89 15 d4 09 00 00    	mov    %edx,0x9d4
}
 518:	5e                   	pop    %esi
 519:	5f                   	pop    %edi
 51a:	5d                   	pop    %ebp
 ...
 549:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 54c:	89 15 d4 09 00 00    	mov    %edx,0x9d4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 569:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 56c:	8b 3d d4 09 00 00    	mov    0x9d4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 5af:	73 4f                	jae    600 <malloc+0xa0>
    ...
    if(p == freep)
 5b1:	8b 3d d4 09 00 00    	mov    0x9d4,%edi
 ...
 5da:	e8 f1 fe ff ff       	call   4d0 <free>
  return freep;
 5df:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
 ...
 60c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 60f:	89 15 d4 09 00 00    	mov    %edx,0x9d4
}
 ...
 61f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 620:	c7 05 d4 09 00 00 d8 	movl   $0x9d8,0x9d4
 627:	09 00 00 
    base.s.size = 0;
 62a:	bf d8 09 00 00       	mov    $0x9d8,%edi
    base.s.ptr = freep = prevp = &base;
 62f:	c7 05 d8 09 00 00 d8 	movl   $0x9d8,0x9d8
 636:	09 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 639:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 63b:	c7 05 dc 09 00 00 00 	movl   $0x0,0x9dc
 642:	00 00 00 
    if(p->s.size >= nunits){
