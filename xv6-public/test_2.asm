...
main(int argc, char *argv[])
{
  ...
  55:	e8 4c 05 00 00       	call   5a6 <clone>
   assert(clone_pid > 0);
  ...
  ce:	e8 63 04 00 00       	call   536 <kill>
  d3:	e8 2e 04 00 00       	call   506 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
 ...
 152:	e8 57 04 00 00       	call   5ae <join>
 ...
 182:	e8 89 06 00 00       	call   810 <free>
   exit();
 187:	e8 7a 03 00 00       	call   506 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1f3:	e8 3e 03 00 00       	call   536 <kill>
 1f8:	e8 09 03 00 00       	call   506 <exit>
   global = tmp1 + tmp2;
 1fd:	01 d9                	add    %ebx,%ecx
 1ff:	89 0d f8 0d 00 00    	mov    %ecx,0xdf8
   exit();
 205:	e8 fc 02 00 00       	call   506 <exit>
 ...
 339:	31 db                	xor    %ebx,%ebx
{
 ...
 345:	57                   	push   %edi
 346:	6a 00                	push   $0x0
 348:	e8 d1 01 00 00       	call   51e <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
 ...
 3ad:	e8 94 01 00 00       	call   546 <open>
  if (fd < 0)
 ...
 3c1:	50                   	push   %eax
 3c2:	e8 97 01 00 00       	call   55e <fstat>
  close(fd);
 3c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3ca:	89 c6                	mov    %eax,%esi
  close(fd);
 3cc:	e8 5d 01 00 00       	call   52e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 46b:	e8 30 04 00 00       	call   8a0 <malloc>
 ...
 47a:	e8 27 01 00 00       	call   5a6 <clone>
...
int thread_join()
{
 ...
 493:	53                   	push   %ebx
 494:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 497:	6a 04                	push   $0x4
 499:	e8 02 04 00 00       	call   8a0 <malloc>
 49e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 4a1:	8d 45 f4             	lea    -0xc(%ebp),%eax
 4a4:	89 04 24             	mov    %eax,(%esp)
 4a7:	e8 02 01 00 00       	call   5ae <join>
 4ac:	89 c3                	mov    %eax,%ebx
 ...
 4b2:	e8 59 03 00 00       	call   810 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 4c3:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 4c6:	83 38 01             	cmpl   $0x1,(%eax)
 4c9:	75 05                	jne    4d0 <lock_acquire+0x10>
 4cb:	eb fe                	jmp    4cb <lock_acquire+0xb>
