...
main(int argc, char *argv[])
{
  ...
  b7:	e8 6a 05 00 00       	call   626 <kill>
  bc:	e8 35 05 00 00       	call   5f6 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  e7:	e8 74 06 00 00       	call   760 <printf>
   exit();
  ec:	e8 05 05 00 00       	call   5f6 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
void nested_worker(void *arg1, void *arg2){
 ...
 169:	e8 b8 04 00 00       	call   626 <kill>
 16e:	e8 83 04 00 00       	call   5f6 <exit>
   assert(global == 2);
 173:	6a 2d                	push   $0x2d
...
worker(void *arg1, void *arg2) {
 ...
 237:	e8 ea 03 00 00       	call   626 <kill>
 23c:	e8 b5 03 00 00       	call   5f6 <exit>
   assert(tmp1 == 42);
 241:	6a 36                	push   $0x36
 ...
 2ec:	e9 25 ff ff ff       	jmp    216 <worker+0x66>
   exit();
 2f1:	e8 00 03 00 00       	call   5f6 <exit>
 ...
 429:	31 db                	xor    %ebx,%ebx
{
 ...
 435:	57                   	push   %edi
 436:	6a 00                	push   $0x0
 438:	e8 d1 01 00 00       	call   60e <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st)
{
 ...
 49d:	e8 94 01 00 00       	call   636 <open>
  if (fd < 0)
 ...
 4b1:	50                   	push   %eax
 4b2:	e8 97 01 00 00       	call   64e <fstat>
  close(fd);
 4b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ba:	89 c6                	mov    %eax,%esi
  close(fd);
 4bc:	e8 5d 01 00 00       	call   61e <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 55b:	e8 30 04 00 00       	call   990 <malloc>
 ...
 56a:	e8 27 01 00 00       	call   696 <clone>
...
int thread_join()
{
 ...
 59c:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 59e:	58                   	pop    %eax
 59f:	ff 75 f4             	push   -0xc(%ebp)
 5a2:	e8 59 03 00 00       	call   900 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 5b3:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 5b6:	83 38 01             	cmpl   $0x1,(%eax)
 5b9:	75 05                	jne    5c0 <lock_acquire+0x10>
 5bb:	eb fe                	jmp    5bb <lock_acquire+0xb>
 5bd:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 5c0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 5c6:	5d                   	pop    %ebp
 5c7:	c3                   	ret    
...
free(void *ap)
{
 ...
 901:	a1 7c 0f 00 00       	mov    0xf7c,%eax
{
 ...
 941:	5b                   	pop    %ebx
  freep = p;
 942:	89 15 7c 0f 00 00    	mov    %edx,0xf7c
}
 948:	5e                   	pop    %esi
 949:	5f                   	pop    %edi
 94a:	5d                   	pop    %ebp
 ...
 979:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 97c:	89 15 7c 0f 00 00    	mov    %edx,0xf7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 999:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 99c:	8b 3d 7c 0f 00 00    	mov    0xf7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9df:	73 4f                	jae    a30 <malloc+0xa0>
    ...
    if(p == freep)
 9e1:	8b 3d 7c 0f 00 00    	mov    0xf7c,%edi
 ...
 a0a:	e8 f1 fe ff ff       	call   900 <free>
  return freep;
 a0f:	8b 15 7c 0f 00 00    	mov    0xf7c,%edx
 ...
 a3c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a3f:	89 15 7c 0f 00 00    	mov    %edx,0xf7c
}
 ...
 a4f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a50:	c7 05 7c 0f 00 00 80 	movl   $0xf80,0xf7c
 a57:	0f 00 00 
    base.s.size = 0;
 a5a:	bf 80 0f 00 00       	mov    $0xf80,%edi
    base.s.ptr = freep = prevp = &base;
 a5f:	c7 05 80 0f 00 00 80 	movl   $0xf80,0xf80
 a66:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a69:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a6b:	c7 05 84 0f 00 00 00 	movl   $0x0,0xf84
 a72:	00 00 00 
    if(p->s.size >= nunits){
