...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 c4 02 00 00       	call   317 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cd:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 49a:	ff 24 85 00 07 00 00 	jmp    *0x700(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4ff:	75 15                	jne    516 <printf+0xfa>
          s = "(null)";
 501:	be f9 06 00 00       	mov    $0x6f9,%esi
...
free(void *ap)
{
 ...
 58e:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 5ca:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5cc:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 5d1:	5b                   	pop    %ebx
 5d2:	5e                   	pop    %esi
 5d3:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 629:	e8 54 ff ff ff       	call   582 <free>
  return freep;
 62e:	a1 b0 0a 00 00       	mov    0xab0,%eax
...
malloc(uint nbytes)
{
 ...
 652:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 655:	8b 0d b0 0a 00 00    	mov    0xab0,%ecx
 ...
 661:	eb 4a                	jmp    6ad <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 663:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 66a:	0a 00 00 
 66d:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 674:	0a 00 00 
    base.s.size = 0;
 677:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 67e:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 681:	b9 b4 0a 00 00       	mov    $0xab4,%ecx
 ...
 692:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 695:	89 0d b0 0a 00 00    	mov    %ecx,0xab0
      return (void*)(p + 1);
 ...
 6b2:	73 d4                	jae    688 <malloc+0x46>
    if(p == freep)
 6b4:	39 05 b0 0a 00 00    	cmp    %eax,0xab0
