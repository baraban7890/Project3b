...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 2ca:	e8 27 01 00 00       	call   3f6 <clone>
...
int thread_join()
{
 ...
 2e3:	53                   	push   %ebx
 2e4:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 2e7:	6a 04                	push   $0x4
 2e9:	e8 02 04 00 00       	call   6f0 <malloc>
 2ee:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 2f1:	8d 45 f4             	lea    -0xc(%ebp),%eax
 2f4:	89 04 24             	mov    %eax,(%esp)
 2f7:	e8 02 01 00 00       	call   3fe <join>
 ...
 302:	e8 59 03 00 00       	call   660 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 313:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 316:	83 38 01             	cmpl   $0x1,(%eax)
 319:	75 05                	jne    320 <lock_acquire+0x10>
 31b:	eb fe                	jmp    31b <lock_acquire+0xb>
 31d:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 320:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 326:	5d                   	pop    %ebp
 327:	c3                   	ret    
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba fc 07 00 00       	mov    $0x7fc,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
