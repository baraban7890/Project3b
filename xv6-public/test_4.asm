...
worker(void *arg1, void *arg2) {
   ...
   exit();
   6:	e8 ac 04 00 00       	call   4b7 <exit>
...
0000000b <main>:
{
  ...
  1b:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  1e:	e8 14 05 00 00       	call   537 <getpid>
  23:	a3 3c 0d 00 00       	mov    %eax,0xd3c
   void *stack, *p = malloc(PGSIZE * 2);
  28:	83 ec 0c             	sub    $0xc,%esp
  2b:	68 00 20 00 00       	push   $0x2000
  30:	e8 fd 07 00 00       	call   832 <malloc>
   assert(p != NULL);
  ...
  52:	e8 00 05 00 00       	call   557 <clone>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	83 f8 ff             	cmp    $0xffffffff,%eax
  5d:	0f 84 92 00 00 00    	je     f5 <main+0xea>
  63:	6a 21                	push   $0x21
  65:	68 bc 08 00 00       	push   $0x8bc
  6a:	68 c5 08 00 00       	push   $0x8c5
  6f:	6a 01                	push   $0x1
  71:	e8 96 05 00 00       	call   60c <printf>
  76:	83 c4 0c             	add    $0xc,%esp
  79:	68 20 09 00 00       	push   $0x920
  7e:	68 d7 08 00 00       	push   $0x8d7
  83:	6a 01                	push   $0x1
  85:	e8 82 05 00 00       	call   60c <printf>
  8a:	83 c4 08             	add    $0x8,%esp
  8d:	68 eb 08 00 00       	push   $0x8eb
  92:	6a 01                	push   $0x1
  94:	e8 73 05 00 00       	call   60c <printf>
  99:	83 c4 04             	add    $0x4,%esp
  9c:	ff 35 3c 0d 00 00    	push   0xd3c
  a2:	e8 40 04 00 00       	call   4e7 <kill>
  a7:	e8 0b 04 00 00       	call   4b7 <exit>
   assert(p != NULL);
  ac:	6a 1b                	push   $0x1b
  ae:	68 bc 08 00 00       	push   $0x8bc
  b3:	68 c5 08 00 00       	push   $0x8c5
  b8:	6a 01                	push   $0x1
  ba:	e8 4d 05 00 00       	call   60c <printf>
  bf:	83 c4 0c             	add    $0xc,%esp
  c2:	68 cd 08 00 00       	push   $0x8cd
  c7:	68 d7 08 00 00       	push   $0x8d7
  cc:	6a 01                	push   $0x1
  ce:	e8 39 05 00 00       	call   60c <printf>
  d3:	83 c4 08             	add    $0x8,%esp
  d6:	68 eb 08 00 00       	push   $0x8eb
  db:	6a 01                	push   $0x1
  dd:	e8 2a 05 00 00       	call   60c <printf>
  e2:	83 c4 04             	add    $0x4,%esp
  e5:	ff 35 3c 0d 00 00    	push   0xd3c
  eb:	e8 f7 03 00 00       	call   4e7 <kill>
  f0:	e8 c2 03 00 00       	call   4b7 <exit>
   stack = sbrk(0);
  f5:	83 ec 0c             	sub    $0xc,%esp
  f8:	6a 00                	push   $0x0
  fa:	e8 40 04 00 00       	call   53f <sbrk>
 ...
 11a:	6a 00                	push   $0x0
 11c:	e8 1e 04 00 00       	call   53f <sbrk>
 121:	89 c2                	mov    %eax,%edx
 123:	89 f0                	mov    %esi,%eax
 125:	29 d0                	sub    %edx,%eax
 127:	05 00 08 00 00       	add    $0x800,%eax
 12c:	89 04 24             	mov    %eax,(%esp)
 12f:	e8 0b 04 00 00       	call   53f <sbrk>
   assert((uint)stack % PGSIZE == 0);
 134:	83 c4 10             	add    $0x10,%esp
 137:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
 13d:	74 49                	je     188 <main+0x17d>
 13f:	6a 27                	push   $0x27
 141:	68 bc 08 00 00       	push   $0x8bc
 146:	68 c5 08 00 00       	push   $0x8c5
 14b:	6a 01                	push   $0x1
 14d:	e8 ba 04 00 00       	call   60c <printf>
 152:	83 c4 0c             	add    $0xc,%esp
 155:	68 f8 08 00 00       	push   $0x8f8
 15a:	68 d7 08 00 00       	push   $0x8d7
 15f:	6a 01                	push   $0x1
 161:	e8 a6 04 00 00       	call   60c <printf>
 166:	83 c4 08             	add    $0x8,%esp
 169:	68 eb 08 00 00       	push   $0x8eb
 16e:	6a 01                	push   $0x1
 170:	e8 97 04 00 00       	call   60c <printf>
 175:	83 c4 04             	add    $0x4,%esp
 178:	ff 35 3c 0d 00 00    	push   0xd3c
 17e:	e8 64 03 00 00       	call   4e7 <kill>
 183:	e8 2f 03 00 00       	call   4b7 <exit>
   assert((uint)sbrk(0) - (uint)stack == PGSIZE/2);
 188:	83 ec 0c             	sub    $0xc,%esp
 18b:	6a 00                	push   $0x0
 18d:	e8 ad 03 00 00       	call   53f <sbrk>
 192:	29 f0                	sub    %esi,%eax
 194:	83 c4 10             	add    $0x10,%esp
 197:	3d 00 08 00 00       	cmp    $0x800,%eax
 19c:	74 49                	je     1e7 <main+0x1dc>
 19e:	6a 28                	push   $0x28
 1a0:	68 bc 08 00 00       	push   $0x8bc
 1a5:	68 c5 08 00 00       	push   $0x8c5
 1aa:	6a 01                	push   $0x1
 1ac:	e8 5b 04 00 00       	call   60c <printf>
 1b1:	83 c4 0c             	add    $0xc,%esp
 1b4:	68 44 09 00 00       	push   $0x944
 1b9:	68 d7 08 00 00       	push   $0x8d7
 1be:	6a 01                	push   $0x1
 1c0:	e8 47 04 00 00       	call   60c <printf>
 1c5:	83 c4 08             	add    $0x8,%esp
 1c8:	68 eb 08 00 00       	push   $0x8eb
 1cd:	6a 01                	push   $0x1
 1cf:	e8 38 04 00 00       	call   60c <printf>
 1d4:	83 c4 04             	add    $0x4,%esp
 1d7:	ff 35 3c 0d 00 00    	push   0xd3c
 1dd:	e8 05 03 00 00       	call   4e7 <kill>
 1e2:	e8 d0 02 00 00       	call   4b7 <exit>
   assert(clone(worker, 0, 0, stack) == -1);
 1e7:	56                   	push   %esi
 1e8:	6a 00                	push   $0x0
 1ea:	6a 00                	push   $0x0
 1ec:	68 00 00 00 00       	push   $0x0
 1f1:	e8 61 03 00 00       	call   557 <clone>
 1f6:	83 c4 10             	add    $0x10,%esp
 1f9:	83 f8 ff             	cmp    $0xffffffff,%eax
 1fc:	74 49                	je     247 <main+0x23c>
 1fe:	6a 2a                	push   $0x2a
 200:	68 bc 08 00 00       	push   $0x8bc
 205:	68 c5 08 00 00       	push   $0x8c5
 20a:	6a 01                	push   $0x1
 20c:	e8 fb 03 00 00       	call   60c <printf>
 211:	83 c4 0c             	add    $0xc,%esp
 214:	68 20 09 00 00       	push   $0x920
 219:	68 d7 08 00 00       	push   $0x8d7
 21e:	6a 01                	push   $0x1
 220:	e8 e7 03 00 00       	call   60c <printf>
 225:	83 c4 08             	add    $0x8,%esp
 228:	68 eb 08 00 00       	push   $0x8eb
 22d:	6a 01                	push   $0x1
 22f:	e8 d8 03 00 00       	call   60c <printf>
 234:	83 c4 04             	add    $0x4,%esp
 237:	ff 35 3c 0d 00 00    	push   0xd3c
 23d:	e8 a5 02 00 00       	call   4e7 <kill>
 242:	e8 70 02 00 00       	call   4b7 <exit>
   printf(1, "TEST PASSED\n");
 247:	83 ec 08             	sub    $0x8,%esp
 24a:	68 12 09 00 00       	push   $0x912
 24f:	6a 01                	push   $0x1
 251:	e8 b6 03 00 00       	call   60c <printf>
   free(p);
 256:	89 1c 24             	mov    %ebx,(%esp)
 259:	e8 14 05 00 00       	call   772 <free>
   exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5bd:	0f b6 92 cc 09 00 00 	movzbl 0x9cc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 68a:	ff 24 85 74 09 00 00 	jmp    *0x974(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 6ef:	75 15                	jne    706 <printf+0xfa>
          s = "(null)";
 6f1:	be 6c 09 00 00       	mov    $0x96c,%esi
...
free(void *ap)
{
 ...
 77e:	a1 40 0d 00 00       	mov    0xd40,%eax
 ...
 7ba:	89 08                	mov    %ecx,(%eax)
  freep = p;
 7bc:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 7c1:	5b                   	pop    %ebx
 7c2:	5e                   	pop    %esi
 7c3:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 819:	e8 54 ff ff ff       	call   772 <free>
  return freep;
 81e:	a1 40 0d 00 00       	mov    0xd40,%eax
...
malloc(uint nbytes)
{
 ...
 842:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 845:	8b 0d 40 0d 00 00    	mov    0xd40,%ecx
 ...
 851:	eb 4a                	jmp    89d <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 853:	c7 05 40 0d 00 00 44 	movl   $0xd44,0xd40
 85a:	0d 00 00 
 85d:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 864:	0d 00 00 
    base.s.size = 0;
 867:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 86e:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 871:	b9 44 0d 00 00       	mov    $0xd44,%ecx
 ...
 882:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 885:	89 0d 40 0d 00 00    	mov    %ecx,0xd40
      return (void*)(p + 1);
 ...
 8a2:	73 d4                	jae    878 <malloc+0x46>
    if(p == freep)
 8a4:	39 05 40 0d 00 00    	cmp    %eax,0xd40
