...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 5da:	e8 27 01 00 00       	call   706 <clone>
...
int thread_join()
{
 ...
 60c:	89 c3                	mov    %eax,%ebx
  ...
  free(stack);
 60e:	58                   	pop    %eax
 60f:	ff 75 f4             	push   -0xc(%ebp)
 612:	e8 59 03 00 00       	call   970 <free>
  lock_release(&lock);
...
void lock_acquire(lock_t *lock)
{
 ...
 623:	8b 45 08             	mov    0x8(%ebp),%eax
  while (lock->flag == 1)
 626:	83 38 01             	cmpl   $0x1,(%eax)
 629:	75 05                	jne    630 <lock_acquire+0x10>
 62b:	eb fe                	jmp    62b <lock_acquire+0xb>
 62d:	8d 76 00             	lea    0x0(%esi),%esi
    ;
  lock->flag = 1;
 630:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
}
 636:	5d                   	pop    %ebp
 637:	c3                   	ret    
 ...
 72c:	89 d1                	mov    %edx,%ecx
{
 ...
 759:	0f b6 92 90 0b 00 00 	movzbl 0xb90(%edx),%edx
 ...
 7d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 849:	ff 24 85 38 0b 00 00 	jmp    *0xb38(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 957:	90                   	nop
          s = "(null)";
 958:	ba 2e 0b 00 00       	mov    $0xb2e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 971:	a1 e0 13 00 00       	mov    0x13e0,%eax
{
 ...
 9b1:	5b                   	pop    %ebx
  freep = p;
 9b2:	89 15 e0 13 00 00    	mov    %edx,0x13e0
}
 9b8:	5e                   	pop    %esi
 9b9:	5f                   	pop    %edi
 9ba:	5d                   	pop    %ebp
 ...
 9e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ec:	89 15 e0 13 00 00    	mov    %edx,0x13e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 3d e0 13 00 00    	mov    0x13e0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4f:	73 4f                	jae    aa0 <malloc+0xa0>
    ...
    if(p == freep)
 a51:	8b 3d e0 13 00 00    	mov    0x13e0,%edi
 ...
 a7a:	e8 f1 fe ff ff       	call   970 <free>
  return freep;
 a7f:	8b 15 e0 13 00 00    	mov    0x13e0,%edx
 ...
 aac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 aaf:	89 15 e0 13 00 00    	mov    %edx,0x13e0
}
 ...
 abf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 ac0:	c7 05 e0 13 00 00 e4 	movl   $0x13e4,0x13e0
 ac7:	13 00 00 
    base.s.size = 0;
 aca:	bf e4 13 00 00       	mov    $0x13e4,%edi
    base.s.ptr = freep = prevp = &base;
 acf:	c7 05 e4 13 00 00 e4 	movl   $0x13e4,0x13e4
 ad6:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ad9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 adb:	c7 05 e8 13 00 00 00 	movl   $0x0,0x13e8
 ae2:	00 00 00 
    if(p->s.size >= nunits){
