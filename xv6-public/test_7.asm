...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 40 04 00 00       	call   456 <getpid>
  16:	a3 80 0c 00 00       	mov    %eax,0xc80

   int fork_pid = fork();
  1b:	e8 ae 03 00 00       	call   3ce <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 4c 04 00 00       	call   47e <join>
   assert(join_pid == -1);
  ...
  76:	e8 8b 03 00 00       	call   406 <kill>
  7b:	e8 56 03 00 00       	call   3d6 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  ...
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 34 03 00 00       	call   3d6 <exit>

   assert(wait() > 0);
  a2:	e8 37 03 00 00       	call   3de <wait>
  ...
  b4:	e8 87 04 00 00       	call   540 <printf>
   exit();
  b9:	e8 18 03 00 00       	call   3d6 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
 ...
 209:	31 db                	xor    %ebx,%ebx
{
 ...
 215:	57                   	push   %edi
 216:	6a 00                	push   $0x0
 218:	e8 d1 01 00 00       	call   3ee <read>
    if (cc < 1)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 33b:	e8 30 04 00 00       	call   770 <malloc>
 ...
 34a:	e8 27 01 00 00       	call   476 <clone>
...
int thread_join()
{
 ...
 363:	53                   	push   %ebx
 364:	83 ec 20             	sub    $0x20,%esp
  int pid;
  void *stack = malloc(sizeof(void *));
 367:	6a 04                	push   $0x4
 369:	e8 02 04 00 00       	call   770 <malloc>
 36e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  pid = join(&stack);
 371:	8d 45 f4             	lea    -0xc(%ebp),%eax
 374:	89 04 24             	mov    %eax,(%esp)
 377:	e8 02 01 00 00       	call   47e <join>
 ...
 6e1:	a1 84 0c 00 00       	mov    0xc84,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 84 0c 00 00    	mov    %edx,0xc84
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 84 0c 00 00    	mov    %edx,0xc84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 84 0c 00 00    	mov    0xc84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 84 0c 00 00    	mov    0xc84,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 84 0c 00 00    	mov    0xc84,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 84 0c 00 00    	mov    %edx,0xc84
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 84 0c 00 00 88 	movl   $0xc88,0xc84
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf 88 0c 00 00       	mov    $0xc88,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 88 0c 00 00 88 	movl   $0xc88,0xc88
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 8c 0c 00 00 00 	movl   $0x0,0xc8c
 852:	00 00 00 
    if(p->s.size >= nunits){
